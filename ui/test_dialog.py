...
class Ui_TestDialog(object):
    def setupUi(self, TestDialog):
        ...
        self.model_name.setProperty(u"class", u"modelName")
        ...
        self.model_meta.setProperty(u"class", u"modelMeta")
        ...
        self.group_source_line.setProperty(u"class", u"dialogSectionLine")
        ...
        self.group_param_line.setProperty(u"class", u"dialogSectionLine")
        ...
        self.conf_note.setProperty(u"class", u"fieldNote")
        ...
        self.iou_note.setProperty(u"class", u"fieldNote")
        ...
        self.out_note.setProperty(u"class", u"fieldNote")
