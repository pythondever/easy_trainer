...
class Ui_ModelDialog(object):
    ...
    def retranslateUi(self, ModelDialog):
        ...
        ___qtablewidgetitem4.setText(QCoreApplication.translate("ModelDialog", u"\u6a21\u578b\u7cbe\u5ea6", None))
        ___qtablewidgetitem5 = self.tableWidget.horizontalHeaderItem(5)
        ___qtablewidgetitem5.setText(QCoreApplication.translate("ModelDialog", u"\u56fe\u50cf\u5c3a\u5bf8", None))
        ___qtablewidgetitem6 = self.tableWidget.horizontalHeaderItem(6)
        ___qtablewidgetitem6.setText(QCoreApplication.translate("ModelDialog", u"\u6a21\u578b\u8def\u5f84", None))
        ___qtablewidgetitem7 = self.tableWidget.horizontalHeaderItem(7)
        ___qtablewidgetitem7.setText(QCoreApplication.translate("ModelDialog", u"\u6570\u636e\u96c6\u4fe1\u606f", None))
        ___qtablewidgetitem8 = self.tableWidget.horizontalHeaderItem(8)
        ___qtablewidgetitem8.setText(QCoreApplication.translate("ModelDialog", u"\u5bfc\u51fa\u6a21\u578b", None))
        ___qtablewidgetitem9 = self.tableWidget.horizontalHeaderItem(9)
        ___qtablewidgetitem9.setText(QCoreApplication.translate("ModelDialog", u"\u6307\u6807", None))
        ___qtablewidgetitem10 = self.tableWidget.horizontalHeaderItem(10)
        ___qtablewidgetitem10.setText(QCoreApplication.translate("ModelDialog", u"\u5220\u9664", None))
        ___qtablewidgetitem11 = self.tableWidget.horizontalHeaderItem(11)
        ___qtablewidgetitem11.setText(QCoreApplication.translate("ModelDialog", u"\u6d4b\u8bd5", None))
