...
################################################################################
## Form generated from reading UI file 'segment.ui'
##
...
class Ui_SegmentDialog(object):
    def setupUi(self, SegmentDialog):
        if not SegmentDialog.objectName():
            SegmentDialog.setObjectName(u"SegmentDialog")
        SegmentDialog.resize(948, 579)
        self.gridLayout = QGridLayout(SegmentDialog)
        ...
        self.train_cfg_label = QLabel(SegmentDialog)
        ...
        self.output_label = QLabel(SegmentDialog)
        self.output_label.setObjectName(u"output_label")

        self.horizontalLayout_8.addWidget(self.output_label)

        self.output_line_txt = QLineEdit(SegmentDialog)
        ...
        self.select_output_path_btn = QPushButton(SegmentDialog)
        ...
        self.start_train = QPushButton(SegmentDialog)
    ...
    def retranslateUi(self, SegmentDialog):
        SegmentDialog.setWindowTitle(QCoreApplication.translate("SegmentDialog", u"\u56fe\u50cf\u5206\u5272\u8bad\u7ec3", None))
        self.train_cfg_label.setText(QCoreApplication.translate("SegmentDialog", u"\u8bad\u7ec3\u53c2\u6570\u914d\u7f6e", None))
        self.dataset_label.setText(QCoreApplication.translate("SegmentDialog", u"\u8bad\u7ec3\u96c6", None))
        self.val_label.setText(QCoreApplication.translate("SegmentDialog", u"\u9a8c\u8bc1\u96c6", None))
        self.network_label.setText(QCoreApplication.translate("SegmentDialog", u"\u7f51\u7edc", None))
        self.device_label.setText(QCoreApplication.translate("SegmentDialog", u"\u8bbe\u5907", None))
        self.img_size_label.setText(QCoreApplication.translate("SegmentDialog", u"\u56fe\u50cf\u5c3a\u5bf8", None))
        self.early_stop_label.setText(QCoreApplication.translate("SegmentDialog", u"\u65e9\u505c", None))
        self.early_stop_line_txt.setText(QCoreApplication.translate("SegmentDialog", u"20", None))
        self.batch_label.setText(QCoreApplication.translate("SegmentDialog", u"\u6279\u6b21", None))
        self.grad_accum_label.setText(QCoreApplication.translate("SegmentDialog", u"\u68af\u5ea6\u7d2f\u79ef", None))
        self.epoch_label.setText(QCoreApplication.translate("SegmentDialog", u"\u8f6e\u6b21", None))
        self.loader_num_label.setText(QCoreApplication.translate("SegmentDialog", u"\u7ebf\u7a0b\u6570", None))
        self.lr_label.setText(QCoreApplication.translate("SegmentDialog", u"\u5b66\u4e60\u7387", None))
        self.output_label.setText(QCoreApplication.translate("SegmentDialog", u"\u8f93\u51fa\u8def\u5f84", None))
        self.output_line_txt.setText("")
        self.select_output_path_btn.setText(QCoreApplication.translate("SegmentDialog", u"\u9009\u62e9\u8def\u5f84", None))
        self.start_train.setText(QCoreApplication.translate("SegmentDialog", u"\u5f00\u59cb\u8bad\u7ec3", None))
    # retranslateUi
