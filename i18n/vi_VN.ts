...
<context>
    ...
    <message>
        ...
        <translation>Mô hình phát hiện bất thường chưa hỗ trợ xuất ONNX (đây là cấu trúc kết hợp giữa xương sống và ngân hàng bộ nhớ), hãy dùng trực tiếp tệp mô hình để kiểm thử trong phần mềm</translation>
    </message>
</context>
<context>
